<div class="mt-6 grid grid-cols-2 gap-2">
    <div class="border border-stone-700 rounded">
        ...
        <form class="p-4 space-y-4">
            ...
            <button type="submit" class="border-stone-800 bg-stone-900 text-stone-400 px-4 py-1 rounded-md border-2 hover:bg-stone-700 cursor-pointer">Logar</button>
        </form>
    </div>
    ...
    <div class="border border-stone-700 rounded">
        ...
        <form class="p-4 space-y-4" method="POST" action="/registrar">
            <?php if (isset($message) && strlen($message > 0)):?>
                <div class="border-green-800 bg-green-900 text-green-400 px-4 py-1 rounded-md border-2 text-sm font-bold"><?= $message ?></div>
            <?php endif; ?>
            ...
            <div class="flex flex-col">
                ...
                <input type="email" name="confirmation_email" class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1 w-full">
            </div>
            ...
            <button type="reset" class="border-stone-800 bg-stone-900 text-stone-400 px-4 py-1 rounded-md border-2 hover:bg-stone-700 cursor-pointer">Cancelar</button>
            <button type="submit" class="border-stone-800 bg-stone-900 text-stone-400 px-4 py-1 rounded-md border-2 hover:bg-stone-700 cursor-pointer">Registrar</button>
        </form>
    </div>
</div>
