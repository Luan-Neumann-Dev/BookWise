    ...
    <div>
        <div class="border border-stone-700 rounded">
            ...
            <form class="p-4 space-y-4" method="POST" action="/livro-criar">
                <?php if ($validations = flash()->get('mensagem')) : ?>
                ...
                <div class="flex flex-col">
                    ...
                    <select name="release_year" class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1 w-full">
